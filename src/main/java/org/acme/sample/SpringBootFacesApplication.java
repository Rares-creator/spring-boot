...
//                sc.setInitParameter(ProjectStage.PROJECT_STAGE_PARAM_NAME,
...
//    private Set<Class<?>> getServletContainerInitializerHandlesTypes(Class<? extends
// ServletContainerInitializer> sciClass) {
