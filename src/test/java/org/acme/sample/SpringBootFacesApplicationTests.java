...
// entity.getBody().contains("javax.faces.ViewState"));
//	}
//
//    @SuppressWarnings({"rawtypes", "unchecked"})
//    @Test
//    public void testActuatorHealthPage() throws Exception {
//        ResponseEntity<Map> entity = new TestRestTemplate().getForEntity("http://localhost:" +
// this.port + actuatorPath + "/health", Map.class);
//        assertEquals(HttpStatus.OK, entity.getStatusCode());
//
